...
export default function LoginPage() {
    ...
    const login = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.error(error);
            setMessage("Đăng nhập thất bại. Vui lòng kiểm tra tài khoản và mật khẩu.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="rounded-3xl border border-white/10 bg-white p-6 text-slate-900 shadow-2xl sm:p-8">
            <p className="mb-2 text-sm font-black uppercase text-lime-600">Chào mừng trở lại</p>
            <h2 className="mb-6 text-3xl font-black">Đăng nhập</h2>
